...
const Formarriveresop = ({ courrier_numero }) => {
    ...
    const handleValidation = async (e) => {
        ...
        console.log(destinatairesInternes.length , "et" , destinatairesExternes.length )
...
const reset_rejection = () =>{
    const R = Rejection.current;
    R.value= "";
    ...
    const Anuuler_rejections = () =>{
        ...
        try {
            ...
            // Vérification des erreurs
            if (!responseSupI.ok || !responseSupD.ok) {
        ...
        <div className="formdeprt d-flex justify-content-center align-items-center">
            ...
            <Form className='fd'>
                ...
                <Row className="depbut mt-4" >
                    <Col md={10}>
                        <Button md={4} className='btn-success' type="submit" ref={submitButtonRef} onClick={handleValidation}>
                            Valider
                        </Button>
                        <Button md={4} ref={rejeterButtonRef} type="submit" onClick={handleRejection} >
                            Rejeter
                        </Button>
                        <Button md={4} className='btn-danger' ref={supprimerButtonRef} type="submit" onClick={handlesuprression} >
                            Supprimer
                        </Button>
