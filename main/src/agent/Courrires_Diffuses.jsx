            ...
            const fetchCourriers = async () => {
                try {
                    const response = await fetch(
                        'http://localhost/ESSAIE/api/controllers/CourrierController.php?action=courrier_Diffuses'
                    );
...
export default Courrier_Diffuses;